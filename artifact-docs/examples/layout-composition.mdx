...
- \`outlined\``}
  />
              ...
              <ComparisonSet title="Compare content shapes" columns={3}>

          <ComparisonSet.Item title="Markdown body" value="markdown-body">
...
<ComparisonSet.Item title="Framed snippet" value="framed-snippet">
  <Frame surface="subtle">
    <MarkdownBody
      variant="compact"
    ...
    />
                  ...
                  <ComparisonSet.Item title="Custom composition" value="custom-composition">
                  <Stack gap="sm">
