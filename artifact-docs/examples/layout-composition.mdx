  ...
  <SplitPane ratio="3:1" gap="lg">
    ...
    >
      <DecisionMatrix.Option
        ...
        verdict="Recommended"
      >
        Agents choose task-oriented components first, then use layout only when composition needs it.
      </DecisionMatrix.Option>
      <DecisionMatrix.Option
        id="layout-first"
      ...
      >
        Agents assemble artifacts from generic layout blocks and arbitrary children.
      </DecisionMatrix.Option>
    </DecisionMatrix>
