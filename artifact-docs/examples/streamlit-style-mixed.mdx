...
>
  <DecisionMatrix.Option
    ...
    pros={["Shortest authoring path", "Agent-friendly", "No extra text API to learn"]}
    cons={["Needs strong default prose styling", "Harder to constrain every edge case"]}
    confidence="high"
...
>
  <OptionGrid.Item
    ...
    tradeoffs={["Best for headings and explanatory paragraphs", "Needs polished document-level CSS"]}
  >
  ...
  <OptionGrid.Item
    ...
    tradeoffs={["Good for reusable components", "Less convenient for top-level prose"]}
  >
  ...
  <OptionGrid.Item
    ...
    intent="Own structured decisions, comparisons, code notes, and export surfaces."
    tradeoffs={["Agent-queryable through the registry", "Should stay higher-level than raw cards"]}
  >
